...
**Next:** Micky sets the SMTP env vars on Railway for the intake form, fixes the dead partner links (WebinarJam, EverWebinar, WebinarNinja, GetResponse, two Fiverr gigs, two Possibol links), merges; then Phase 5 batch 3 (remaining ondernemen + online-geld-verdienen).
