...
**Next:** Micky reviews batch 1 (58 notes on the board) and fixes the four dead partner links; then Phase 5 batch 2 (next 10–15 articles, ondernemen first). Briefing 2 (the `/automatisering/` service page, D26) is applied on the branch.
