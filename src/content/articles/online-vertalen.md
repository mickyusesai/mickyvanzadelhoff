...
Een ideale bron van inkomsten als je graag de wereld over reist of vanuit huis werkt. Dat er geld valt te verdienen met online vertalen heb ik al meermaals mogen ondervinden. Zelf vertaal ik dan niet (moet nog werken aan mijn spelling soms…), maar ik heb al vaker **vertalers benaderd voor het vertalen van webteksten** van mijn klanten.

Vaak was dit voor het vertalen van een website zodat deze ook een andere doelgroep aanspreekt. Andere teksten waarvoor een vertaler wordt ingehuurd zijn onder andere **rapporten, contracten, reisgidsen, testamenten, boeken of social media posts**.

Zeker is dat je geld kan verdienen met (online) vertalen. Dit omdat voor veel vertalingen een **Google translate** of **OpenAI** niet volstaat. Hoe je geld verdient met vertalen bespreken we in dit artikel.
...
Met de opkomst van kunstmatige intelligentie (Chat GPT etc.) en de ontwikkeling daarvan in 2023 is de toekomst van online vertalen wat onzeker. Het op een juiste manier vertalen van teksten wordt voor computers **steeds beter mogelijk**. Zeker met de breder gesproken talen gaat dit proces erg snel.
